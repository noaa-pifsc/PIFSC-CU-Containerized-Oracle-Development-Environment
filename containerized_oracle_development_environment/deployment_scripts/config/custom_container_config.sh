...
##### Project Configuration Variables: #####
	...
	declare GIT_URL="--branch Branch_CODE_v1.4_CDD_install_prevent_merge_conflicts git@github.com:noaa-pifsc/PIFSC-Containerized-Oracle-Development-Environment.git"
